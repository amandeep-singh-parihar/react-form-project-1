...
function App() {
    ...
    return (
        <div className="w-full flex flex-col items-center">
            <form
                className="w-[55vw] border-2 hover:shadow-2xl ease-linear transition-all duration-300 px-5 my-4 rounded-md"
            ...
            >
                ...
                <div>
                    <h3 className="text-base font-semibold mt-4">First Name</h3>
                    <input
                ...
                <div>
                    <h3 className="text-base font-semibold mt-4">Last Name</h3>
                    <input
                        onChange={changeHandler}
                        className="border-2 rounded h-[35px] w-full px-2"
                        type="text"
                ...
                <div>
                    <h3 className="text-base font-semibold mt-4">Email</h3>
                    <input
                        onChange={changeHandler}
                        className="border-2 rounded h-[35px] w-full px-2"
                        type="email"
                ...
                <div>
                    <h3 className="text-base font-semibold mt-4">Country</h3>
                    <select
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex gap-3">
                            <input
                                ...
                                id="everything"
                                checked={
                                    formData.pushNotification === "everything"
                                }
                            />
                            <label
                                className="text-base font-semibold"
